import styles from "../PhimDangChieu/PhimDangChieu.module.css"; // Tạo file CSS cho style của bạn
    ...
    <div className={styles.pageContainer}>
      <div className={styles.container}>
        <div className={styles.sidebar}>
          ...
          <button className={styles.sidebarItem}>Thể loại</button>
          <button className={styles.sidebarItem}>Ngày khởi chiếu</button>
          <button className={styles.sidebarItem}>Trailer</button>
          <button className={styles.sidebarItem}>Phim có ưu đãi</button>
        ...
        <div className={styles.content}>
          <div className={styles.buttonsContainer}>
            <Link to="/PhimDangChieu">
              <button className={styles.buttons}>PHIM ĐANG CHIẾU</button>
            </Link>
            <Link to="/PhimSapChieu">
              <button className={styles.buttons}>PHIM SẮP CHIẾU</button>
            </Link>
          </div>
