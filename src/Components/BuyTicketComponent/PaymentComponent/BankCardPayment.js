...
import TopUpComplete from '../../MemberInfoComponent/TopUpComplete'

import backgroundCard from './PaymentIcon/backgroundCard.png';
import logo1 from './PaymentIcon/logoMBbank.png'; 
import logo2 from './PaymentIcon/logoTechcombank.png';
import icon1 from './PaymentIcon/visaSymbol.png';
import icon2 from './PaymentIcon/activeSymbol.png';
import icon3 from './PaymentIcon/chip.png';
import icon4 from './PaymentIcon/contactless.png';
import icon5 from './PaymentIcon/napas.png';

const BankCardPayment = ({Logo,Icon1_2, finalAmount, useFor, handleTopUp, ticketInfo, onPaymentSuccessful}) => {
  ...
  return (
    ...
    <div className ={styles.fillingCard}>
      ...
      <div className={styles.inputContainer}>
        ...
        {!(useFor==='ahd')&&<PaymentButton satisfied={satisfied} useFor='online' ticketInfo={ticketInfo} paymentData={{paymentType:"bankCard",info :itemPosition}} onPaymentSuccessful={onPaymentSuccessful} finalAmount={finalAmount}/>} 
