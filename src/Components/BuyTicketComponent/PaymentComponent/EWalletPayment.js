...
import iconZaloPay from './PaymentIcon/zalopayIcon.png';  
import iconMomo from './PaymentIcon/momoIcon.png';

import CountdownTimer2 from './CountdownTimer2'
import PaymentButton from './PaymentButton'
import TopUpComplete from'../../MemberInfoComponent/TopUpComplete'
const EwalletPayment = ({ewalletSelected, finalAmount, useFor, handleTopUp, ticketInfo, onPaymentSuccessful}) => {
    ...
    return (
        ...
        {!(useFor==='ahd')&&<PaymentButton satisfied={satisfied} useFor='online' ticketInfo={ticketInfo} paymentData={{paymentType: "ewallet",info: text}} onPaymentSuccessful={onPaymentSuccessful} finalAmount={finalAmount}/>}
