...
import walletIcon from './PaymentIcon/walletIcon.png'

import TransactionConfirmation from './TransactionConfirmation'
import Success from './Success'
const PaymentButton=({satisfied, useFor, ticketInfo, paymentData, onPaymentSuccessful, finalAmount})=>{
    ...
    return(
        ...
        {
            isSuccess&&
            <Success onResetSuccess={handleTransactionConfirmation} useFor="ticketPurchase"/>
        }
        </div>
    )
}
